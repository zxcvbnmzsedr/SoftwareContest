...
class Utils
{
	...
	private static Vector RotateBy(Vector points, double theta)
	{
		return RotateByRadians(points, theta);
	}
	
	// rotate the points by the given radians about their centroid
	private static Vector RotateByRadians(Vector points, double radians)
	{
	...
	private static Vector ScaleToSquare(Vector points, double size, Rectangle boundingBox)
	{
	...
	private static double DistanceAtAngle(Vector points, Template T, double theta)
	{
...
//	#region Lengths and Rects	
	...
	private static Rectangle BoundingBox(Vector points)
	{
...
//		foreach (Point p in points)
	...
	private static void BoundingBox(Vector points, Rectangle dst)
	{
		double minX = Double.MAX_VALUE;
		double maxX = Double.MIN_VALUE;
		double minY = Double.MAX_VALUE;
...
//		foreach (Point p in points)
	...
	private static Point Centroid(Vector points)
	{
		double xsum = 0.0;
		double ysum = 0.0;
...
//		foreach (Point p in points)
	...
	private static double PathDistance(Vector path1, Vector path2)
	{            
		double distance = 0;
